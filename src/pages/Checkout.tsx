              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center justify-center gap-2.5">
                    ...
                    {/* Apple Pay */}
                    <svg width="42" height="24" viewBox="0 0 56 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect x="0.5" y="0.5" width="55" height="31" rx="3.5" fill="#000" stroke="#333"/>
                      <path d="M14.5 10.3c-.5.6-1.2 1-2 .9-.1-.8.3-1.6.7-2.1.5-.6 1.3-1 2-.9.1.8-.2 1.6-.7 2.1zm.7 1.1c-1.1-.1-2.1.6-2.6.6-.5 0-1.3-.6-2.2-.6-1.1 0-2.2.7-2.8 1.7-1.2 2.1-.3 5.2.9 6.9.6.8 1.3 1.8 2.2 1.7.9 0 1.2-.6 2.3-.6 1 0 1.3.6 2.3.6 1 0 1.6-.9 2.2-1.7.7-1 .9-1.9.9-2 0 0-1.9-.7-1.9-2.8 0-1.8 1.5-2.7 1.5-2.7-.8-1.2-2-1.3-2.5-1.3l-.3.2z" fill="white"/>
                      <path d="M22.5 21.5h-1.7V9.5h1.7v12zm6.5-8.6h.04c.3-.5.9-.9 1.8-.9 1.9 0 3 1.5 3 3.7 0 2.2-1.2 3.7-3 3.7-.9 0-1.5-.4-1.9-.9h-.04v3.6h-1.6V13h1.6v-.1zm-.04 3c0 1.5.8 2.4 1.9 2.4 1.1 0 1.9-1 1.9-2.5s-.8-2.5-1.9-2.5c-1.1 0-1.9 1-1.9 2.6zm8.5 3.6c-1 0-1.8-.5-2.2-1.4l1.4-.6c.3.5.7.7 1.2.7.6 0 1-.3 1-.7 0-.5-.6-.6-1.3-.8-1-.3-2-.7-2-1.9 0-1.2 1-2 2.3-2 .9 0 1.6.4 2 1.1l-1.3.6c-.2-.4-.6-.5-.9-.5-.5 0-.8.2-.8.6 0 .4.5.5 1.1.7 1 .3 2.2.6 2.2 2 0 1.3-1.1 2.1-2.4 2.1h-.3zm5.5 0c-1.4 0-2.1-.8-2.1-2.2V14h-1v-1.2h1V11h1.7v1.8h1.3V14h-1.3v3c0 .8.3 1.1.9 1.1h.5v1.3c-.3.1-.7.1-1 .1z" fill="white"/>
                    </svg>
                  </div>
                </div>
