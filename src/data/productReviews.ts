...
export const productReviews: Record<string, ProductReview[]> = {
  ...
  'stronger-with-you-intensely': [
    ...
    { id: 3, name: 'Francesco', text: 'There\'s a reason everyone has this. It\'s just that good.', verified: true, rating: 4.5, date: '2 weeks ago' },
    { id: 4, name: 'Giovanni', text: 'Warm, inviting, and absolutely addictive. 10/10.', verified: true, rating: 5, date: '3 weeks ago' },
    { id: 5, name: 'Luca', text: 'Best Armani fragrance hands down. The longevity is insane.', verified: true, rating: 4, date: '1 month ago' },
  ],
  'le-beau-le-parfum': [
    ...
    { id: 3, name: 'Louis', text: 'Best Le Beau version. Tropical but still sophisticated.', verified: true, rating: 4.5, date: '2 weeks ago' },
    { id: 4, name: 'Hugo', text: 'Compliment beast. Everyone asks what I\'m wearing.', verified: true, rating: 4, date: '1 month ago' },
  ],
  'spicebomb-extreme': [
