...
export const productReviews: Record<string, ProductReview[]> = {
  ...
  'stronger-with-you-intensely': [
    { id: 1, name: 'vinceNT', text: 'Genuinely one of the best cold weather scents I own. That chestnut note just hits different when it\'s freezing out.', verified: true, rating: 5, date: '4 days ago' },
    { id: 2, name: 'marcosR', text: 'My girlfriend stole my bottle. That\'s the review.', verified: true, rating: 5, date: '1 week ago' },
    { id: 3, name: 'K_wells', text: 'Sweet and warm without being too much. I get compliments but it\'s not a room-filler or anything. Sits close to the skin after about 2 hours. I like that about it honestly.', verified: true, rating: 4.5, date: '2 weeks ago' },
    { id: 4, name: 'pfragrance', text: 'Good scent but I feel like it fades quicker than people say. Maybe 5 hours on me tops. The vanilla-toffee thing is nice, just wish it lasted longer for the price.', verified: true, rating: 3.5, date: '3 weeks ago' },
    { id: 5, name: 'JamieL_', text: 'Wore it to dinner and my friend asked what it was. That never happens with my other fragrances so that says something. Very cozy, a bit boozy. Perfect for dates.', verified: true, rating: 5, date: '1 month ago' },
    { id: 6, name: 'oud_head', text: 'Decent. It does what every other sweet designer does but with a chestnut twist. Not bad, not mind-blowing. If you already have Ultra Male or Spicebomb you probably don\'t need this too.', verified: true, rating: 3.5, date: '1 month ago' },
    { id: 7, name: 'SimonDK', text: 'The sage in the opening saves this from being another generic sweet fragrance. Gives it a slightly herbal quality that balances everything out. Really well made.', verified: true, rating: 4.5, date: '2 months ago' },
    { id: 8, name: 'Leo_paris', text: 'Third bottle. That\'s it. That\'s the review. Okay fine — it smells like autumn in a bottle and I can\'t stop reaching for it.', verified: true, rating: 5, date: '2 months ago' },
  ],
  'le-beau-le-parfum': [
    ...
    { id: 2, name: 'samG_', text: 'Solid summer scent. The coconut doesn\'t go sunscreen territory which was my main worry. It stays creamy and warm. Not the longest lasting thing ever but I don\'t mind reapplying.', verified: true, rating: 4, date: '1 week ago' },
    { id: 3, name: 'Lucas_BE', text: 'Bought this blind based on reviews and I\'m glad I did. It\'s easygoing, clean, slightly sweet. My kind of fragrance.', verified: true, rating: 5, date: '2 weeks ago' },
    { id: 4, name: 'noseknows22', text: 'It\'s fine. Nothing wrong with it at all, just didn\'t blow me away the way Le Male Elixir did. The coconut phase is the best part but takes a while to get there.', verified: true, rating: 3.5, date: '3 weeks ago' },
    { id: 5, name: 'RyanT', text: 'Wore this every day last summer. Something about that pineapple-coconut combo just works without being tacky. Gets me compliments from people who normally don\'t comment on cologne.', verified: true, rating: 5, date: '1 month ago' },
    { id: 6, name: 'H_berg', text: 'Nice tropical vibe with some depth to it. The tonka and sandalwood in the base keep it grounded. Works best in warm weather obviously but I\'ve worn it in spring too.', verified: true, rating: 4.5, date: '6 weeks ago' },
  ],
  'spicebomb-extreme': [
