...
export const products: Product[] = [
  // ===== FRAGRANCE BUNDLES =====
  {
    ...
    brand: 'Profparfums',
    price: 26.99,
    originalPrice: 240.50,
    category: 'bundle',
    description: '"Evening Sweetheart" Bundle – top-tier sweet bangers for the night. Got a date? A party? These fragrances will make you unforgettable.\n\n• Le Male Elixir – Creamy vanilla and honey wrapped around cool lavender and mint, with a soft tobacco touch.\n• Born in Roma Intense – Warm, intoxicating blend of creamy vanilla and aromatic lavender over earthy vetiver.\n• The Most Wanted Parfum – Cozy winter fragrance with ginger fizz calming into a beautiful bourbon vanilla.\n• Le Male Le Parfum – Complex oriental character with warm spices and woods, luxurious and enveloping.\n• Stronger With You Intensely – Powerful warmth with pink pepper, toffee, and vanilla settling into deep amber.',
    ...
    isBundle: true,
    variants: [
      { ml: 50, price: 26.99, originalPrice: 240.50, inStock: true },
      { ml: 100, price: 32.99, originalPrice: 359.50, inStock: true },
    ],
  },
  {
    ...
    category: 'bundle',
    description: '"Young Playboy" Bundle – 5 legendary fragrances in one package. Looking for a set that delivers fresh, bold, and versatile scents.\n\n• Le Male Elixir – Creamy vanilla and honey wrapped around cool lavender and mint, with a soft tobacco touch.\n• Dior Sauvage Parfum – Smooth, dark take on Sauvage with creamy sandalwood, vanilla, and incense.\n• Versace Eros – Cool mint, green apple, and lemon over sweet vanilla and woods – playful and bold.\n• Stronger With You Absolutely – The most intense Stronger With You – deep, addictive, and irresistible.\n• 1 Million Elixir – A bold, sweet amber fragrance with rich vanilla and warm spicy notes.',
    ...
    isBundle: true,
    variants: [
      { ml: 50, price: 27.99, originalPrice: 225.00, inStock: true },
      { ml: 100, price: 32.99, originalPrice: 332.00, inStock: true },
    ],
  },
  {
    ...
    brand: 'Profparfums',
    price: 25.99,
    originalPrice: 176.42,
    category: 'bundle',
    description: 'Looking for fragrances that work anytime, anywhere? This set is your daily go-to – fresh, masculine, and clean.\n\n• YSL Myself EDP – Refined and elegant, celebrating individuality with floral and woody notes.\n• YSL Y Eau de Parfum – Fresh yet powerful with crisp apple, ginger, and bergamot over warm amberwood.\n• Acqua di Gio – A timeless fresh aquatic fragrance with citrus and marine notes.\n• Dior Sauvage Parfum – Smooth, dark take on Sauvage with creamy sandalwood, vanilla, and incense.\n• Armani Code – A sophisticated blend of warm spices, leather, and tonka bean.',
    ...
    isBundle: true,
    variants: [
      { ml: 50, price: 25.99, originalPrice: 176.42, inStock: true },
      { ml: 100, price: 31.99, originalPrice: 285.42, inStock: true },
    ],
  },
