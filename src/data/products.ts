...
export const products: Product[] = [
  ...
  },
  {
    ...
    inStock: true,
    variants: [
      { ml: 50, price: 8.99, originalPrice: 52.50, inStock: true },
      { ml: 100, price: 13.99, originalPrice: 77.50, inStock: true },
    ],
  },
  {
    id: '1-million-parfum',
  ...
  },
  {
    ...
    originalPrice: 55.00,
    category: 'women',
    description: 'Prada Paradoxe is a shape-shifting floral amber fragrance that evolves on every skin. A modern and sophisticated scent built around a unique molecular structure, blending bright neroli and sensual musks with warm amber. Its a fragrance that celebrates individuality and reinvention.',
    scentNotes: {
      top: [],
      heart: [],
      base: [],
    ...
    inStock: true,
    variants: [
      { ml: 50, price: 9.99, originalPrice: 55.00, inStock: true },
      { ml: 90, price: 14.99, originalPrice: 80.00, inStock: true },
    ],
  },
  {
    id: 'phantom-parfum',
