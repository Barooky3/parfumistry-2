...
export const products: Product[] = [
  // ===== FRAGRANCE BUNDLES =====
  {
    ...
    variants: [
      { ml: 50, price: 31.99, originalPrice: 155.50, inStock: true, label: 'All 50ml (75ml for JPG)' },
      { ml: 100, price: 37.99, originalPrice: 274.50, inStock: true, label: 'All 100ml (125ml for JPG)' },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      { ml: 50, price: 30.99, originalPrice: 116.42, inStock: true },
  ...
  // ===== FRAGRANCES =====
  {
    ...
    featured: true,
    variants: [
      { ml: 60, price: 16.99, originalPrice: 74.50, inStock: false },
      { ml: 120, price: 23.99, originalPrice: 109.50, inStock: false },
    ],
  },
  {
    id: 'althair',
    ...
    featured: true,
    variants: [
      { ml: 75, price: 23.99, originalPrice: 140.50, inStock: true },
      { ml: 125, price: 29.99, originalPrice: 190.50, inStock: true },
    ],
  },
  {
    id: 'aoud-lemon-mint',
  ...
  },
  {
    ...
    variants: [
      ...
      { ml: 120, price: 24.49, originalPrice: 109.50, inStock: true },
    ],
  },
  {
    id: 'aventus',
  ...
  },
  {
    ...
    inStock: true,
    variants: [
      { ml: 50, price: 13.99, originalPrice: 62.50, inStock: true },
      { ml: 100, price: 18.99, originalPrice: 87.50, inStock: true },
    ],
  },
  {
    id: 'black-orchid',
    ...
    variants: [
      ...
      { ml: 100, price: 24.99, originalPrice: 142.50, inStock: true },
    ],
  },
  {
    ...
    inStock: true,
    variants: [
      { ml: 50, price: 16.99, originalPrice: 38.50, inStock: true },
      { ml: 100, price: 23.99, originalPrice: 62.50, inStock: true },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      ...
      { ml: 120, price: 22.99, originalPrice: 109.50, inStock: false },
    ],
  },
  {
    id: 'delina',
    ...
    featured: true,
    variants: [
      { ml: 30, price: 20.99, originalPrice: 57.97, inStock: true },
      { ml: 75, price: 27.99, originalPrice: 78.97, inStock: true },
    ],
  },
  {
    id: 'erba-gold',
  ...
  },
  {
    ...
    variants: [
      ...
      { ml: 100, price: 23.99, originalPrice: 69.50, inStock: true },
    ],
  },
  {
    id: 'eros-flame',
    ...
    variants: [
      ...
      { ml: 100, price: 23.99, originalPrice: 82.50, inStock: true },
    ],
  },
  {
    id: 'eros-parfum',
    ...
    variants: [
      ...
      { ml: 100, price: 19.99, originalPrice: 69.50, inStock: false },
    ],
  },
  {
    id: 'prada-paradoxe',
    ...
    inStock: true,
    variants: [
      { ml: 50, price: 14.99, originalPrice: 65.00, inStock: true },
      { ml: 90, price: 19.99, originalPrice: 90.00, inStock: true },
    ],
  },
  {
    id: 'french-riviera',
    ...
    variants: [
      ...
      { ml: 120, price: 24.99, originalPrice: 109.50, inStock: false },
    ],
  },
  {
    id: 'homme-intense',
    ...
    variants: [
      ...
      { ml: 100, price: 29.99, originalPrice: 127.50, inStock: true },
    ],
  },
  {
    id: 'imagination',
    ...
    featured: true,
    variants: [
      { ml: 100, price: 28.99, originalPrice: 225.00, inStock: true },
      { ml: 200, price: 34.99, originalPrice: 290.00, inStock: true },
    ],
  },
  {
    id: 'khamrah-parfum',
    ...
    featured: true,
    variants: [
      { ml: 100, price: 11.99, originalPrice: 74.50, inStock: true },
    ],
  },
  {
    id: 'khamrah-qahwa',
  ...
  },
  {
    ...
    featured: true,
    variants: [
      { ml: 75, price: 24.49, inStock: true },
      { ml: 125, price: 30.49, inStock: true },
    ],
  },
  // ===== BEST SELLERS =====
  {
    ...
    featured: true,
    variants: [
      { ml: 50, price: 14.99, originalPrice: 44.50, inStock: true },
      { ml: 100, price: 21.99, originalPrice: 69.50, inStock: true },
      { ml: 150, price: 27.99, originalPrice: 89.50, inStock: true },
    ],
  },
  {
    ...
    featured: true,
    variants: [
      { ml: 75, price: 12.99, originalPrice: 62.50, inStock: true },
      { ml: 125, price: 18.99, originalPrice: 87.50, inStock: true },
    ],
  },
  {
    ...
    featured: true,
    variants: [
      { ml: 50, price: 16.99, originalPrice: 44.50, inStock: false },
      { ml: 90, price: 23.99, originalPrice: 69.50, inStock: false },
    ],
  },
  {
    ...
    featured: true,
    variants: [
      { ml: 50, price: 14.99, originalPrice: 56.50, inStock: true },
      { ml: 100, price: 21.99, originalPrice: 82.50, inStock: true },
    ],
  },
  {
    id: '1-million-parfum',
    ...
    inStock: true,
    variants: [
      { ml: 50, price: 14.99, originalPrice: 62.50, inStock: true },
      { ml: 100, price: 20.99, originalPrice: 87.50, inStock: true },
    ],
  },
  {
    id: 'le-male-elixir',
    ...
    featured: true,
    variants: [
      { ml: 75, price: 16.99, originalPrice: 77.50, inStock: true },
      { ml: 125, price: 22.99, originalPrice: 102.50, inStock: true },
    ],
  },
  {
    ...
    featured: true,
    variants: [
      { ml: 50, price: 15.99, originalPrice: 62.50, inStock: true },
  ...
  },
  {
    ...
    variants: [
      ...
      { ml: 50, price: 16.99, originalPrice: 72.50, inStock: true },
      { ml: 90, price: 21.99, originalPrice: 102.50, inStock: true },
    ],
  },
  {
    ...
    featured: true,
    variants: [
      { ml: 75, price: 14.99, originalPrice: 67.50, inStock: true },
      { ml: 125, price: 21.99, originalPrice: 87.50, inStock: true },
    ],
  },
  // ===== ADDITIONAL PRODUCTS =====
  {
    ...
    variants: [
      ...
      { ml: 125, price: 18.99, originalPrice: 77.50, inStock: false },
    ],
  },
  {
    ...
    variants: [
      ...
      { ml: 125, price: 22.49, originalPrice: 95.00, inStock: true },
    ],
  },
  {
    id: 'libre',
    ...
    featured: true,
    variants: [
      { ml: 30, price: 12.99, originalPrice: 56.50, inStock: true },
      { ml: 50, price: 16.99, originalPrice: 77.50, inStock: true },
      { ml: 90, price: 21.99, originalPrice: 102.50, inStock: true },
    ],
  },
  {
    ...
    variants: [
      ...
      { ml: 50, price: 14.99, originalPrice: 49.96, inStock: true },
      { ml: 90, price: 19.99, originalPrice: 69.96, inStock: true },
    ],
  },
  {
    id: 'myself-edp',
    ...
    variants: [
      ...
      { ml: 60, price: 14.99, originalPrice: 49.96, inStock: true },
      { ml: 100, price: 20.99, originalPrice: 73.96, inStock: true },
    ],
  },
  {
    id: 'phantom-parfum',
  ...
  },
  {
    ...
    variants: [
      { ml: 40, price: 12.99, originalPrice: 41.96, inStock: true },
      { ml: 60, price: 14.99, originalPrice: 49.96, inStock: true },
      { ml: 100, price: 18.99, originalPrice: 73.96, inStock: true },
    ],
  },
  {
    id: 'naxos',
  ...
  },
  {
    ...
    variants: [
      ...
      { ml: 100, price: 23.99, originalPrice: 102.50, inStock: true },
    ],
  },
  {
    id: 'red-tobacco',
  ...
  },
  {
    ...
    featured: true,
    variants: [
      { ml: 60, price: 13.99, originalPrice: 62.50, inStock: true },
      { ml: 100, price: 17.99, originalPrice: 87.50, inStock: true },
      { ml: 200, price: 24.99, originalPrice: 127.50, inStock: true },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      ...
      { ml: 100, price: 20.99, originalPrice: 77.50, inStock: true },
    ],
  },
  {
    ...
    variants: [
      ...
      { ml: 100, price: 21.99, originalPrice: 72.50, inStock: true },
    ],
  },
  {
  ...
  {
    id: 'stronger-with-you-powerfully',
    name: 'Stronger With You Powerfully',
    brand: 'Giorgio Armani',
    price: 14.99,
    originalPrice: 58.50,
    category: 'men',
    description: 'The newest addition to the Stronger With You line, Powerfully is a sweet gourmand cherry bomb. Opens with juicy cherry and mandarin orange, develops into a warm spiced lavender heart, and dries down to a cozy chestnut, vanilla, and amberwood base. Think cherry pie meets cozy evening vibes.',
    scentNotes: {
    ...
    accentColor: '#8B0000',
    image: '/images/scent-notes/stronger-with-you-powerfully.png',
    imagePadding: 'p-[1.2rem] md:p-[2.7rem]',
    affiliateUrl: '/product/stronger-with-you-powerfully',
    inStock: true,
    variants: [
      { ml: 50, price: 14.99, originalPrice: 58.50, inStock: true },
      { ml: 100, price: 20.99, originalPrice: 82.50, inStock: true },
    ],
  },
  {
    id: 'symphony',
