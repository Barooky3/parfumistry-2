...
serve(async (req) => {
  try {
    ...
    return new Response(
      buildResultPage("Proof Requested ✅", `An email has been sent to ${order.customer_email} asking for proof of payment. Their reply will come directly to your inbox.`, true),
